...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	...
	<body>
		...
		var pkBaseURL = (("https:" == document.location.protocol) ? "https://pw.baobab-erlebnisbar.de/" : "http://pw.baobab-erlebnisbar.de/");
		...
		</script><noscript><p><img src="http://pw.baobab-erlebnisbar.de/piwik.php?idsite=6" style="border:0" alt="" /></p></noscript>
