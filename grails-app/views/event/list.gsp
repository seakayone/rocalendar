			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="entryFee" title="${message(code: 'event.entryFee.label', default: 'Entry Fee')}" />
					
						<g:sortableColumn property="filenameFlyer" title="${message(code: 'event.filenameFlyer.label', default: 'Filename Flyer')}" />
				...
				<g:each in="${eventInstanceList}" status="i" var="eventInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: eventInstance, field: "entryFee")}</td>
					
						<td>${fieldValue(bean: eventInstance, field: "filenameFlyer")}</td>
